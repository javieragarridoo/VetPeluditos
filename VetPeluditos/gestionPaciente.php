...
<head>
    ...
    <link rel="stylesheet" href="vetModulos.css">
...
<nav class="navbar">
 <ul>
     <li><a href="gestionCitas.php">Gestion de citas</a></li>
     <li><a href="gestionPaciente.php">Gestion de pacientes</a></li>
     <li><a href="historialConsulta.php">Historial de consultas</a></li>
...
<br>
    ...
    $consulta = "SELECT usuarios.id, usuarios.nombre, usuarios.telefono, usuarios.email
     FROM usuarios
    LEFT JOIN roles ON usuarios.id_rol = roles.id_rol where usuarios.id=3";
